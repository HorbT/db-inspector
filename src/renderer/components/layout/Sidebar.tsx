...
export function Sidebar(): React.ReactElement {
  ...
  return (
    <aside className="w-52 bg-sidebar-bg text-sidebar-fg flex flex-col border-r border-sidebar-hover">
      {/* Logo area */}
      <div className="p-4 border-b border-sidebar-hover">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <div className="text-[10px] text-sidebar-fg/50">统一数据库巡检平台</div>
          </div>
        </div>
      </div>
      ...
      <div className="p-3 border-t border-sidebar-hover">
        <div className="text-[10px] text-sidebar-fg/40 text-center">
          v1.0.0
        </div>
      </div>
    </aside>
